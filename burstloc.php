...
/* PHP function to burst a Library of Congress call number into its individual parts
   ...
   Output is an associative array containing alpha class, numeric class (two fields to allow for decimal),
...
*/
  ...
  if (strcmp(substr($lcnum,$count,1),".") !== 0) {
    return array("ClassAlpha" => "ERROR", "ClassNum" => $lcnum, "ClassNumDec" => "", "1stCutter" => "", "2ndCutter" => "");
    }
...
// Return the array's individual parts, in order
